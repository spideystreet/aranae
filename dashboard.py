...
try:
    ...
    cities = st.sidebar.multiselect("Select City", options=sorted(df['city'].dropna().unique()), default=[])
    ...
    display_cols = ['source', 'publication_date', 'title', 'company', 'city', 'region', 'salary', 'tjm', 'duration', 'experience_level', 'offer_url']
